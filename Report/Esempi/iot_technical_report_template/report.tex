...
\PaperTitle{Titolo della relazione} % Article title

\Authors{NomeStudente CognomeStudente\textsuperscript{1}*, Emanuele Lattanzi\textsuperscript{2}} % Il docente Emanuele Lattanzi figura come autore
...
\affiliation{*\textbf{Corresponding author}: email\_studente@campus.uniurb.it} % Corresponding author
